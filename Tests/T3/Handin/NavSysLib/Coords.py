...
class WGS84Coords:
    ...
    def get_position_from_orbits_and_pseudoranges_non_iterative(
        self, orbits, pseudoranges, wn, tow, elevation_mask,
        num_iter=10, tol=1e-6, initial_guess=None
    ):
        import numpy as np
        ...
        for iter_count in range(num_iter):
            ...
            for i, ob in enumerate(visible_orbits):
                ...
                # t_rx = tow + wn * 604800.0
                t_rx_total = tow + wn * 604800.0
                # the true transmission time computed non-iteratively:
                t_tx_new = t_rx_total - pr / c
